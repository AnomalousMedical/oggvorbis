...
cd $BUILD_FOLDER
xcodebuild clean -sdk iphoneos8.3 SHARED_PRECOMPS_DIR="$BUILD_FOLDER/SharedTmpPCH"

xcodebuild -configuration Release -sdk iphoneos8.3 ONLY_ACTIVE_ARCH=NO ARCHS="armv7 armv7s arm64" SHARED_PRECOMPS_DIR="$BUILD_FOLDER/SharedTmpPCH"
